...
import rok.board.like.entity.ArticleLikeCount;
import rok.board.like.repository.ArticleLikeCountRepository;
...
public class ArticleLikeService {
    ...
    public void likePessimisticLock1(Long articleId, Long userId) {
        ...
        int res = articleLikeCountRepository.increase(articleId);
        if(res == 0){
            // 최초 요청 시에는 Update 되는 레코드가 없으므로, 1로 초기화된다.
